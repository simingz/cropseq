...
# Analysis based on Siwei's data from cell ranger
```{r siweicode, eval=F}
library(Matrix)
matrix_dir = "../data/data_from_Siwei/Xin_scRNA_seq_05Nov2018/filtered_gene_bc_matrices/CellRanger_index/"

matrix_dir = "/Volumes/alan/CROP-seq/NSC08_cellranger/outs/filtered_gene_bc_matrices/cellranger_ref/"
...
mat1 <- tail(mat,n=76)
length(colSums(mat1)[colSums(mat1)==1])
```
